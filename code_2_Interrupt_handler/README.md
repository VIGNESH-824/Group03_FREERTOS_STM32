...
#include "main.h"
#include "cmsis_os.h"
void HAL_GPIO_WritePins(GPIO_TypeDef* GPIOx, uint16_t GPIO_Start_Pin, GPIO_PinState Val);
int var = 0;
...
//	HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, 0);
  ...
  {
#if 0
	HAL_GPIO_WritePins(GPIOD, 12, 1);
	osDelay(500);
	HAL_GPIO_WritePins(GPIOD, 12, 2);
	osDelay(500);
	HAL_GPIO_WritePins(GPIOD, 12, 15);
	osDelay(500);
# endif
